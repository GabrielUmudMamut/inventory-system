...
PROMPT_TEMPLATE = """
You are an expert bakery business consultant. Analyse the average daily sales data below.
...
{{
    "summary": "A 2-sentence overall evaluation of the bakery's performance.",
    "alerts": [
